...
<div style="display: <?php if (isset($log_success)) echo $log_success ?>; width: 20%; height: 100px; position: fixed;left: 80%; " id="swal23" class="swal2-container swal2-top-end swal2-backdrop-hidden">
...
<div style="display: <?php if (isset($log_note)) echo $log_note ?>; width: 20%; height: 100px; position: fixed;left: 80%;" class="swal2-container swal2-top-end swal2-backdrop-hidden">
